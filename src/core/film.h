...
namespace rt3 {
    ...
    class Film {
        public:
            ...
            // Convert the data from the matrix into an image array.
            unsigned char* convertImage() const;
            ...
            void operator=(const Film& other);

            //=== Film Public Data
            Point2i m_full_resolution;    //!< The image's full resolution values.
