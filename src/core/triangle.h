...
class Triangle : public Shape {
	private:
		...
		TriangleMesh * mesh; //!< This is the **indexed triangle mesh database** this triangle is linked to.
	...
	public:
		...
		Triangle( TriangleMesh * mesh, int tri_id, bool bfc=true )
...
vector<Shape *> create_triangle_mesh( TriangleMesh * , bool );
...
void extract_obj_data( const tinyobj::attrib_t& attrib,
                       ...
                       bool rvo, bool cn, bool fn, TriangleMesh * md );
