...
namespace rt3 {
    ...
    std::string CSTR_LOWERCASE (const char* t);
    //{
    //    std::string str{ t };
    ...
    std::string STR_LOWERCASE(const string& t);
    //{
    //    std::string str{ t };
    //    std::transform( str.begin(), str.end(), str.begin(), ::tolower );
    //    return str;
    ...
    std::string STR_LOWER(const char* c_str);
    //{
